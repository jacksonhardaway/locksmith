...
import gg.moonflower.locksmith.common.network.play.handler.LocksmithServerPlayPacketHandlerImpl;
...
public class LocksmithMessages {
    ...
    public static final PollinatedPlayNetworkChannel PLAY = NetworkRegistry.createPlay(new ResourceLocation(Locksmith.MOD_ID, "play"), "1", () -> LocksmithClientPlayPacketHandlerImpl::new, () -> LocksmithServerPlayPacketHandlerImpl::new);
    ...
    public static void init() {
        ...
        PLAY.register(ServerboundLockPickingPacket.class, ServerboundLockPickingPacket::new, PollinatedPacketDirection.PLAY_SERVERBOUND);
    }
}
