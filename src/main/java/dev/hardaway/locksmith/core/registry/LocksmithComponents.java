...
public class LocksmithComponents {
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<LockData>> LOCK_DATA = REGISTRY.registerComponentType("lock_data", builder -> builder.persistent(LockData.CODEC).networkSynchronized(LockData.STREAM_CODEC).cacheEncoding());
